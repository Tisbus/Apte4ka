 ...
 * Use the [PreparationDetailFragment.newInstance] factory method to
...
class PreparationDetailFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment PreparationDetailFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PreparationDetailFragment().apply {
